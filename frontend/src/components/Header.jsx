    ...
    <header className="sticky top-0 z-50 glass border-b border-white/5">
      <div className="flex items-center justify-between px-4 py-2.5">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-accent to-cyan-500 flex items-center justify-center flex-shrink-0">
            <span className="text-sm">⚡</span>
          </div>
          <div>
            <span className="text-sm font-semibold text-white/90 tracking-tight">LLM Router</span>
            <div className="flex items-center gap-1.5 mt-px">
              <div className={`w-1.5 h-1.5 rounded-full bg-gradient-to-r ${meta.color}`} />
              <span className="text-[10px] text-white/35 font-medium">{isRu ? meta.labelRu : meta.label}</span>
            </div>
          </div>
        </div>
        <div className="flex items-center gap-1.5">
          ...
          <button onClick={onRoleChange} className="p-1.5 rounded-md bg-white/5 text-white/30 hover:bg-white/10 hover:text-white/50 transition-all" title={t.changeRole}>
