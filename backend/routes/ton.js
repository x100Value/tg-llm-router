...
router.post('/api/user/:telegramId/ton-link', async (req, res) => {
  try {
...
router.get('/api/user/:telegramId/ton-wallet', async (req, res) => {
  try {
...
router.delete('/api/user/:telegramId/ton-wallet', async (req, res) => {
  try {
